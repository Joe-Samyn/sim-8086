...
class TestArithmeticDecode(unittest.TestCase):
    ...
    def test_adc_reg_mem_w_reg(self):
        # Arrange
        testFile = f'{TEST_BINARIES_DIR}/adc_reg_mem_w_reg.bin'
    ...
    def test_adc_imm_to_acc(self):
        # Arrange
        testFile = f'{TEST_BINARIES_DIR}/adc_imm_to_acc.bin'
