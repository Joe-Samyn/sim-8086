...
#define Const(type, bits) { type, 0b##bits, 0, 0 }
...
INST(MOV, { B(Op, 100010), D_bits, { W_bit, 0b1, 0, 1}, Mod_bits, Rm_bits, Reg_bits } ), \
INST_ALT(MOV, { B(Op, 1100011), Const(D_bit, 0), { W_bit, 0b1, 0, 1 }, Mod_bits, B(Const_bit, 000), Rm_bits, Imm_bits } ) \
