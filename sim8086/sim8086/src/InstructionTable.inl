...
#define OpExtension(bits) { OpExtension, 0b##bits, 3, 3 }
#define Imm { Imm_bit, 0, 0, 0 }
#define Addr { Addr_bit, 0, 0, 0 }
#define D { D_bit, 0b1, 1, 1 }
#define W { W_bit, 0b1, 0, 1 }
#define Mod {Mod_bit, 0b11, 6, 2 }
#define Reg { Reg_bit, 0b111, 3, 3 }
#define Rm { Rm_bit, 0b111, 0, 3 }
#define S {S_bit, 0b1, 1, 1}
...
INST(DEC, {B(Op, 1111111), Const(D_bit, 0b0), { W_bit, 0b1, 0, 1}, Mod, OpExtension(001), Rm})
